...
Public Class TokenList
    ...
    Function GetResult() As Token
        ...
        'Dim tokenString = ExpandTokens()
        'For Each op As String In ParserUtility.operators
        '    Dim allIndexes = ParserUtility.AllIndexesOf(tokenString, op)
        '    Dim allIndexesNoSpaces = ParserUtility.AllIndexesOf(tokenString.Replace(" ", ""), op)
        ...
        '        Dim currentOperator = Item(ii).ToString()
